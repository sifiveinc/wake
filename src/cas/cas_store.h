...
enum class CASError { NotFound, IOError, AlreadyExists, InvalidHash };
...
class CASStore {
 public:
  ...
  wcl::result<bool, CASError> materialize_blob(const ContentHash& hash, const std::string& dest_path,
                                               mode_t mode) const;
